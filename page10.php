...
<body>
    ...
    ?>
    <br><br>
    <h1 class="fst-italic text-center">Créer et ajouter un nouveau panier</h1>
    <br><br>
    <h2 class="fst-italic text-center">Définie en POO</h2>
    <br><br>
    <p class="fst-italic text-center">Ajouter un panier</p>
    <br><br>
    <p class="fst-italic text-center">Ici se pose la limite de travailler sans base de données. Dans cet exemple,
        nous pouvons créer un nouveau panier, mais a chaque fois que je vais sélectionner panier3, celui ci va disparaitre.
        Au rechargement de la page, les infos stockées pour notre nouveau panier disparaissent vu qu'elles ne sont stockées nulle part.
        Il faut donc créer une base de données afin que notre base de stockage soit alimenté et puisse etre affichée de nouveau
        lorsque nous l'appelerons en sélectionnant le panier3
    </p>
    <br><br>
    ...
    <div class="fst-italic text-center border border-warning">
        <div class="">
            ...
            echo '<br>';
            echo '<pre>';
            print_r($nouveauPanier);
            // notre nouveau panier est crée, pourtant il ne s'affiche pas
